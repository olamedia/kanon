...
class yCoreAutoloader extends yAutoloader{
    ...
    protected $_classes = array(
        ...
        'yBuffer'=>'output/yBuffer.php',
        'yCallable'=>'callable/yCallable.php',
        'yCoreAutoloader'=>'autoload/yCoreAutoloader.php',
        'yDebugger'=>'debug/yDebugger.php',
        'yDimension'=>'geometry/yDimension.php',
        'yDirectory'=>'file/yDirectory.php',
        'yDocBlock'=>'doc/yDocBlock.php',
        'yDocumentor'=>'doc/yDocumentor.php',
        'yException'=>'exception/yException.php',
        'yExceptionHandler'=>'exception/yExceptionHandler.php',
        'yFile'=>'file/yFile.php',
        'yFileSystem'=>'file/yFileSystem.php',
        'yLocalFileSystem'=>'file/yLocalFileSystem.php',
        'yLogMessage'=>'log/yLogMessage.php',
        'yLogRoute'=>'log/yLogRoute.php',
        'yLogger'=>'log/yLogger.php',
        'yMethodDocumentor'=>'doc/yMethodDocumentor.php',
        'yMethodNotImplementedException'=>'exception/yMethodNotImplementedException.php',
        'yPoint'=>'geometry/yPoint.php',
        'yProfiler'=>'profiler/yProfiler.php',
        'yRectangle'=>'geometry/yRectangle.php',
        'yStderrLogRoute'=>'log/yStderrLogRoute.php',
        'yStdoutLogRoute'=>'log/yStdoutLogRoute.php',
        'yStreamLogRoute'=>'log/yStreamLogRoute.php',
        'yUri'=>'uri/yUri.php',
